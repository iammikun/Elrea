  ...
  return (
    <div className={classes.container}>
      <div className={classes.wrapper}>
        <h1>
          <span>WE ARE CREATING THE FUTURE</span> through an intense synergy of
          activities in the technological and innovation ecosystem.
        </h1>
        <p>
        ...
        <p>
          We focus on Information Technology Solutions, software development and
          enterprise solutions. We are bent on creating a Future that unites
